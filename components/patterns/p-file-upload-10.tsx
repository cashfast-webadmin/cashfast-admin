...
import { ImageIcon, UploadIcon, XIcon, CloudUploadIcon, CircleAlertIcon } from "lucide-react"
...
export function Pattern({
  ...
  return (
    <div className={cn("w-full space-y-4", className)}>
      ...
      <div
        className={cn(
          "group border-border rounded-md relative overflow-hidden border transition-all duration-200",
          isDragging
